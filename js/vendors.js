  ...
  var m = {
    ...
    g = (function () {
      ...
      if (
        ...
        t.ios &&
          t.osVersion &&
          0 <= e.indexOf("Version/index.html") &&
    ...
    R = {
      ...
      getPathValues: function () {
        var e = J.location.pathname
            .slice(1)
            .split("http://stukram.mikhailmasterov.com/")
            .filter(function (e) {
              return "" !== e;
            }),
          t = e.length;
...
!(function (n, t) {
  ...
  var s = new f(),
    ...
    h = m,
    l = g,
    v = "http://stukram.mikhailmasterov.com/",
    p = new RegExp(
      [
        "(\\\\.)",
        "(?:\\:(\\w+)(?:\\(((?:\\\\.|[^\\\\()])+)\\))?|\\(((?:\\\\.|[^\\\\()])+)\\))([+*?])?",
  ...
  function (e, t, n) {
    ...
    var l,
      ...
      p =
        ...
        -1 < d.userAgent.indexOf("Trident/index.html") ||
        -1 < d.userAgent.indexOf("Edge/index.html"),
